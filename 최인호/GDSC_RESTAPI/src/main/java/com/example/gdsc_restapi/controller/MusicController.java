package com.example.gdsc_restapi.controller;

import com.example.gdsc_restapi.dto.MusicDto;
import com.example.gdsc_restapi.service.MusicService;
...
public class MusicController {
    ...
    public void save(@RequestBody MusicDto musicDto) {musicService.saveMusic(musicDto);}
